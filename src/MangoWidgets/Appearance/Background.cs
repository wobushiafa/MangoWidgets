...
public static class Background
{
    ...
    public static bool RestoreContentBackground(Window window)
    {
        ...
        window.Background = new SolidColorBrush(Color.FromArgb(0xFF, 0xFA, 0xFA, 0xFA));
    ...
    internal static void UpdateAll(BackgroundType backdropType = BackgroundType.Unknown)
    {
        var handles = AppearanceData.ModifiedBackgroundHandles;
