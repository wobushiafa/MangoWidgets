...
internal static class Hicon
{
    ...
    public static IntPtr FromApp()
    {
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to get application hIcon - {e}", "MangoWidgets.Hicon");
            throw;
#endif
            return IntPtr.Zero;
        }
    ...
    public static IntPtr FromSource(ImageSource source)
    {
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to allocate hIcon, Decoder source is empty", "MangoWidgets.Hicon");
#endif
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to allocate hIcon, allocation failed.", "MangoWidgets.Hicon");
#endif
